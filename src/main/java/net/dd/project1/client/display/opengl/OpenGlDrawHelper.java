...
public class OpenGlDrawHelper implements DrawHelper {
  ...
  @Override
  public void drawRect(int x, int y, int width, int height, DrawColor color) {
  ...
  @Override
  public void fillOval(int x, int y, int width, int height, DrawColor color) {
    glColor3f(color.getRed(), color.getGreen(), color.getBlue());
  ...
  @Override
  public void fillCircle(int x, int y, int radius, DrawColor color) {
